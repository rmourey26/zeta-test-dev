...
export interface StakingInterface extends utils.Interface {
  functions: {
    ...
    "beneficiary(bytes)": FunctionFragment;
    "chainID()": FunctionFragment;
    "claimRewards(bytes)": FunctionFragment;
    "decimals()": FunctionFragment;
    "decreaseAllowance(address,uint256)": FunctionFragment;
    "increaseAllowance(address,uint256)": FunctionFragment;
    "lastStakeTime(bytes)": FunctionFragment;
    "name()": FunctionFragment;
    "onCrossChainCall((bytes,address,uint256),address,uint256,bytes)": FunctionFragment;
    "queryRewards(bytes)": FunctionFragment;
    "rewardRate()": FunctionFragment;
    "stakes(bytes)": FunctionFragment;
