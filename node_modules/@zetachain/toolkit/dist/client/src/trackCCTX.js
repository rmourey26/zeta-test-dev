...
const fetchCCTXData = async function (hash, emitter, spinners, API, cctxs, pendingNonces, json) {
...
const trackCCTX = async function ({ hash, json = false, emitter = null, }) {
    const spinners = {};
        ...
        const intervalID = setInterval(async () => {
            ...
            if (Object.keys(cctxs).length > 0) {
                ...
                for (const hash in cctxs) {
                    try {
                        fetchCCTXData.call(this, hash, emitter, spinners, API, cctxs, pendingNonces, json);
                    }
                    catch (error) { }
                }
            }
